...
namespace SujinsLogic
{
    ...
    public static class Boveda
    {
        ...
        private static string LoadMonsterCards()
        {
            ...
            Random r = new Random();
            TypeMonsterElement[] elements = new TypeMonsterElement[]
            {
                TypeMonsterElement.Water,
                TypeMonsterElement.Fire,
                TypeMonsterElement.Rock,
                TypeMonsterElement.Flying,
                TypeMonsterElement.Dark
            };
            ...
            for (int i = 0; i < monsterData.Length; i++)
            {
                ...
                MonsterCard monster = new MonsterCard(
                    ...
                    elements[r.Next(0, elements.Length)]    // Type
                );
